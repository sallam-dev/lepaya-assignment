...
- No deployment mechanism was given, so Docker containers was used for portability
...
- `processors` contains the business logic related to each endpoint. It can depend on repositories interfaces for data persistance.
...
- Allow the user to interact with the history and move back in it

### Technical Improvements
- Proper logging library for the backend
